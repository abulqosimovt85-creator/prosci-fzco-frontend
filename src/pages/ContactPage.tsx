          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl bg-slate-50 p-5 border border-slate-100">
                ...
                <a href="mailto:info@psci-sol.com" className="block mt-3 text-sm font-semibold text-slate-900 hover:text-brand-700 transition">info@psci-sol.com</a>
              </div>
              <div className="rounded-3xl bg-slate-50 p-5 border border-slate-100">
                <p className="text-xs uppercase font-bold tracking-[0.35em] text-slate-400">Phone</p>
                <a href="tel:+971527810506" className="block mt-3 text-sm font-semibold text-slate-900 hover:text-brand-700 transition">+971 52 781 0506</a>
              </div>
            </div>
          </div>
        </div>
